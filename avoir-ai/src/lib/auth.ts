      ...
      Cognito: {
        ...
        loginWith: {
          ...
          oauth: {
            ...
            scopes: ['email', 'openid'],
            redirectSignIn: [process.env.NEXT_PUBLIC_SITE_URL ? `${process.env.NEXT_PUBLIC_SITE_URL}/` : 'http://localhost:3000/'],
            redirectSignOut: [process.env.NEXT_PUBLIC_SITE_URL ? `${process.env.NEXT_PUBLIC_SITE_URL}/` : 'http://localhost:3000/'],
            responseType: 'code'
          }
        },
