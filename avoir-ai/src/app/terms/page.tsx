    ...
    <div className="min-h-screen bg-background text-foreground px-6 py-20" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed text-sm md:text-base">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">2. Description of Services & AI Outputs</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">3. Subscriptions, Payments, and Taxes</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">5. Acceptable Use Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">6. Indemnification</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">9. Dispute Resolution by Binding Arbitration</h2>
            <p>
