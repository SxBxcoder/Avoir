    ...
    <div className="min-h-screen bg-background text-foreground px-6 py-20" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed text-sm md:text-base">
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">1. Introduction & Scope</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">3. Generative AI & Data Usage</h2>
            <p className="mb-4">
            ...
            <p className="font-bold text-foreground mb-2">Zero-Retention & Non-Training Guarantees:</p>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">4. Data Sharing & Subprocessors</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">5. Data Retention & Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">6. Your Data Rights (GDPR & CCPA)</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">7. Cookies & Tracking Technologies</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">8. Changes to Our Privacy Policy</h2>
            <p>
