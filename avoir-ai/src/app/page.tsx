      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 sm:gap-3 group shrink-0">
          <motion.div whileHover={{ rotate: 12, scale: 1.1 }} transition={springBouncy}>
            <Image src="/logo.png" alt="Avoir" width={32} height={32} className="rounded-lg sm:w-9 sm:h-9" />
          </motion.div>
          <span className="text-base sm:text-lg font-bold tracking-tight">
            Avoir<span className="text-indigo-400">.ai</span>
          </span>
        </Link>
...
export default function Home() {
  ...
  const features = [
    {
      ...
      description: 'Extract predictive consumer sentiment and market trends before they hit mainstream media.',
    ...
    },
    {
      ...
      description: 'Our proprietary 6-tier AI system orchestrates multiple quant models for execution strategies no single AI can match.',
    ...
    },
    {
      ...
      description: 'Deploy targeted, high-frequency marketing assets to manipulate engagement and drive asset value.',
    ...
    },
    {
      ...
      description: 'Real-time competitive intelligence. Know exactly where capital is flowing across global sectors.',
    ...
    },
    {
      ...
      title: 'Trend Sniper',
      description: 'Auto-detect viral market anomalies across alternative data sources to execute high-conviction trades.',
    ...
    },
    {
      ...
      title: 'Capital Memory',
      description: 'The AI learns market behavior. Every strategy gets more precise and profitable over time.',
  ...
  const steps = [
    { number: '01', title: 'Ingest & Analyze', description: 'Feed the engine your market objectives. The AI instantly processes millions of data points to find hidden alpha.' },
    { number: '02', title: 'AI Orchestrates', description: 'The Diamond Cascade fires 6 specialized AI models in sequence to formulate an aggressive execution strategy.' },
    { number: '03', title: 'Deploy & Dominate', description: 'Execute high-frequency trades and launch algorithmic marketing campaigns to guarantee ROI.' },
  ];
    ...
    <div className="min-h-screen bg-transparent text-white overflow-x-hidden relative" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            <Image src="/logo.png" alt="Avoir" width={72} height={72} className="rounded-2xl shadow-2xl shadow-indigo-500/20" />
          </motion.div>
          ...
          >
            <span className="block">The Ultimate AI</span>
            <span className="block mt-2 fluid-text-hero">Quantitative Engine</span>
          </motion.h1>
      ...
      <section className="relative py-16 border-y border-white/5">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            {[
              { value: 100, suffix: 'M+', label: 'AUM Deployed' },
              { value: 50000, suffix: '+', label: 'Trades Executed' },
              { value: 6, suffix: '', label: 'Quant Models' },
      ...
      <section id="how-it-works" className="relative py-32">
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
              Three steps to{' '}
              <span className="fluid-text-hero">alpha generation</span>
            </h2>
          </motion.div>
      ...
      <section className="relative py-32">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <motion.div
            ...
            transition={springSmooth}
          >
            <Image src="/logo.png" alt="Avoir" width={56} height={56} className="mx-auto mb-8 rounded-xl shadow-lg shadow-indigo-500/20" />
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <Image src="/logo.png" alt="Avoir" width={28} height={28} className="rounded-lg" />
